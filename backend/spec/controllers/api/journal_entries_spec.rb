...
RSpec.describe "Journal Entries API", type: :request do
  before do
    @order = FactoryBot.build(:order, ordered_at: "2023-02-05", price_per_item: 40, quantity: 3, shipping_cost: 8, tax_rate: 0.07)
    FactoryBot.build(:payment, order: @order, amount: 120)
  end
